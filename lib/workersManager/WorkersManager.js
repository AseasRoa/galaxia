...
class WorkersManager {
  ...
  /**
   * @param {Galaxia.Options} [options]
   * @returns {Required<Galaxia.Options>}
   */
  #fixOptions(options = {}) {
 ...
 */
async function forkWorkers(workersCount, env, mandatoryEvent) {
 ...
 * @returns {Promise<void>}
 */
async function killWorkers(workersMap, gracefully, signal = 'SIGTERM') {
