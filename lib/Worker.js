...
/** @type {ProcessMessage} */ let a = { cmd: 'heartbeat' }
...
class Worker
{
	...
	constructor()
	{
		...
		let app = this.createApp(appPath, this.develop)
	...
	createApp(path, develop)
	{
		//let App = require('./app.js') // delayed require, because the global variables must be set first

		return new App(path, develop)
	}
