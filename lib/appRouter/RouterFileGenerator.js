...
`
  ...
  return routesFetcher('', module, router, [], '${name}', arguments, ajaxVersion, '')
}
`
  }
  ...
  #generateMethod(name, isAsync) {
    ...
    return `
  ${async}${name}() {
    return routesFetcher(this.constructor.name, module, router, this.#constructorArgs, '${name}', arguments, ajaxVersion, this.#sessionKey)
  }
`
  }
