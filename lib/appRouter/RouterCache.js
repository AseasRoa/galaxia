...
/** @type {Map<string, RouterCacheItem>} */
...
class RouterCache {
  ...
  getClassInstance(uniqueFileKey) {
    ...
    if (this.#sessionKey && routerCache.has(this.#sessionKey)) {
      const cacheRecord = routerCache.get(this.#sessionKey)
  ...
  setClassInstance(uniqueFileKey, exports) {
    ...
    if (!routerCache.has(this.#sessionKey)) {
      routerCache.set(this.#sessionKey, {
    ...
    routerCache.get(this.#sessionKey)?.exportsMap.set(uniqueFileKey, exports)
...
export { RouterCache, deleteFromCache }
